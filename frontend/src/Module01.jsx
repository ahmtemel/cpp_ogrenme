    ...
    <>
      ...
      <main>
        <section ref={contentRef} onMouseUp={handleTextSelection}>
          ...
          <p>
            C++'ta bellek yönetimi, programınızın performansını doğrudan etkileyen kritik bir konudur. İki ana bellek alanı vardır: Stack (yığın) ve Heap (yığın).
          </p>
          <ul>
              <li>
                  <b>Stack (Yığın):</b> Otomatik olarak yönetilir. Fonksiyon çağrıları ve yerel değişkenler burada saklanır. Hızlıdır ancak boyutu küçüktür ve nesneler sadece tanımlandıkları fonksiyonun ömrü boyunca yaşar.
              </li>
              <li>
                  <b>Heap (Yığın):</b> Dinamik bellek alanıdır ve manuel olarak yönetilir. `new` anahtar kelimesi ile bellek ayırırsınız ve bu nesneler, `delete` ile serbest bırakılana kadar varlığını sürdürür. Heap, daha büyük nesneler için idealdir.
              </li>
          </ul>
          <p>
            <b>Göreviniz (BraiiiiiiinnnzzzZ):</b> `Zombie` sınıfı implementasyonunu, stack ve heap üzerinde nesneler oluşturarak pekiştirmeniz gerekiyor. Bu, nesne ömrü yönetimini anlamak için hayati öneme sahiptir.
          </p>
          ...
          <p>
            C++'ın en güçlü özelliklerinden biri olan işaretçiler ve referanslar, bir değişkenin bellek adresine doğrudan erişmenizi sağlar.
          </p>
          <ul>
              <li>
                  <b>İşaretçi (`*`):</b> Bir değişkenin bellek adresini saklayan bir değişkendir. Boş değer (`nullptr`) alabilir.
              </li>
              <li>
                  <b>Referans (`&`):</b> Bir değişkene verilmiş bir takma addır. Başka bir değişkeni işaret edemez ve `null` olamaz.
              </li>
          </ul>
          <p>Aşağıdaki kodu çalıştırarak bir işaretçinin ve bir referansın aynı bellek adresini nasıl gösterebileceğini gözlemleyebilirsiniz. Bu, <b>HI THIS IS BRAIN</b> görevi için önemli bir adımdır.</p>
          <div className="editor-section">
              <h3>📚 Örnek: İşaretçi ve Referansın Farkı</h3>
              <p>Aşağıdaki kodu çalıştırarak bir işaretçinin ve bir referansın aynı bellek adresini nasıl gösterebileceğini gözlemleyebilirsiniz.</p>
              <CodeEditor 
                  code={lessonCode2} 
          ...
          <div className="editor-section">
              ...
              <p>Kendi kodunuzu yazarak işaretçi ve referansları deneyin. Kendi değişkenlerinizi oluşturup adreslerini ve değerlerini ekrana yazdırın.</p>
              <CodeEditor 
                  code={freeCode} 
                  setCode={setFreeCode} 
                  output={freeOutput} 
